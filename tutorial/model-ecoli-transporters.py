...
Rule('RXN0_1721',
	prot(name = 'EG10155_MONOMER', loc = 'omem') +
...
Rule('TRANS_RXN_58',
	prot(name = 'LYSP_MONOMER', loc = 'imem') +
	met(name = 'PROTON', loc = 'cyt', strain = 'ecoli', prot = None) +
	met(name = 'LYS', loc = 'cyt', strain = 'ecoli', prot = None) | 
	prot(name = 'LYSP_MONOMER', loc = 'imem') +
	met(name = 'PROTON', loc = 'cyt', strain = 'ecoli', prot = None) +
