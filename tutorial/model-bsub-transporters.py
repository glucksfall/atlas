...
Rule('TRANS_RXN0_487',
	prot(name = 'BSU05470_MONOMER', loc = 'pmem', strain = 'BSUB') +
	met(name = 'MNplus2', loc = 'cyt', strain = 'BSUB', prot = None) | 
	prot(name = 'BSU05470_MONOMER', loc = 'pmem', strain = 'BSUB') +
	met(name = 'MNplus2', loc = 'cyt', strain = 'BSUB', prot = None), 
...
Rule('TRANS_RXN_42',
	prot(name = 'BSU09850_MONOMER', loc = 'pmem', strain = 'BSUB') +
	met(name = 'PROTON', loc = 'cyt', strain = 'BSUB', prot = None) +
	met(name = 'Kplus', loc = 'cyt', strain = 'BSUB', prot = None) | 
	prot(name = 'BSU09850_MONOMER', loc = 'pmem', strain = 'BSUB') +
	met(name = 'PROTON', loc = 'cyt', strain = 'BSUB', prot = None) +
	met(name = 'Kplus', loc = 'cyt', strain = 'BSUB', prot = None), 
...
Rule('TRANS_RXN_141',
	prot(name = 'BSU13300_MONOMER', loc = 'pmem', strain = 'BSUB') +
	met(name = 'MGplus2', loc = 'cyt', strain = 'BSUB', prot = None) | 
	prot(name = 'BSU13300_MONOMER', loc = 'pmem', strain = 'BSUB') +
	met(name = 'MGplus2', loc = 'cyt', strain = 'BSUB', prot = None), 
...
Rule('ATPSYN_RXN',
	cplx(name = 'CPLX8J2_101', loc = 'pmem', strain = 'BSUB') +
	met(name = 'ADP', loc = 'cyt', strain = 'BSUB', prot = None) +
	met(name = 'Pi', loc = 'cyt', strain = 'BSUB', prot = None) +
	met(name = 'PROTON', loc = 'cyt', strain = 'BSUB', prot = None) | 
	cplx(name = 'CPLX8J2_101', loc = 'pmem', strain = 'BSUB') +
...
Rule('TRANS_RXN_156',
	cplx(name = 'CPLX8J2_116', loc = 'pmem', strain = 'BSUB') +
	met(name = 'Hpr_pi_phospho_L_histidines', loc = 'cyt', strain = 'BSUB', prot = None) +
	met(name = 'MANNITOL', loc = 'cyt', strain = 'BSUB', prot = None) | 
	cplx(name = 'CPLX8J2_116', loc = 'pmem', strain = 'BSUB') +
...
Rule('TRANS_RXN_101',
	cplx(name = 'CPLX8J2_158', loc = 'pmem', strain = 'BSUB') +
	met(name = 'NAplus', loc = 'cyt', strain = 'BSUB', prot = None) +
	met(name = 'PROTON', loc = 'cyt', strain = 'BSUB', prot = None) | 
	cplx(name = 'CPLX8J2_158', loc = 'pmem', strain = 'BSUB') +
	met(name = 'PROTON', loc = 'cyt', strain = 'BSUB', prot = None) +
